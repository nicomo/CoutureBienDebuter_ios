...
- .jpg
- quality 25%
- select size according to destination of picture in text: 
...
- save in appropriate directory (create if necessary) according to destination, using file name referenced in photoshop, e.g. 0580R1.jpg
	-- standalone images in assets/img/
...
4/ sketches, logos, etc used in text and available as .svg. They should resepct the same sizes as the pictures above, according to their destination in the text (slideshow, standalone, etc). Save in assets/img/img_svg/